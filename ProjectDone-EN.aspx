<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectDone-EN.aspx.cs" Inherits="Amr_Groups.ProjectDone_EN" %>
...
.dropdown:hover .dropbtn {
    background-color: #3e8e41;
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AmrGroupsConnectionString %>" SelectCommand="SELECT IDPIC, [Name-En], Destionation, UID FROM tblMasterPic WHERE ([Case] = @Case )">
                <SelectParameters>
                    <asp:Parameter DefaultValue="2" Name="Case" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
