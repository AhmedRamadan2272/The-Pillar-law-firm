<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubPic_En.aspx.cs" Inherits="Amr_Groups.SubPic_En" %>
...
<head id="Head1" runat="server">
    ...
    <meta name="category" content="Constructions : Real estate construction company" />    <meta name="date-creation-yyyymmdd" content="20160701" />
    <meta name="date-revision-yyyymmdd" content="20160703" />
      <!--<base href="http://www.liftproegypt.com/index -AR" />  -->
      <meta name="msvalidate.01" content="759FB68CE6589DFC93759D1994F05314" />
      <meta name="robots" content="index, follow" />
      <meta name="keywords" content=" lifts , Epoxy series,ESCALATORS & MOVING WALKS , Forest series , Freight series , Galaxy series , HOME lift,Inox series , Panoramic series , Prestige series,VPL 
      we are working in all kinds of elevators,we can do all kinds of Installation , Maintenance for all kind of lifts for more kinds of lifts and offers please keep in touch with us ."/>  
  
      <meta name="description" content="Egyptian lifts  Company located in Cairo. We Specialize in Installation all kind of lifts and Maintenance  all kind of lifts.
       Lift pro company is working in all kinds of elevators as following:-
      Machine above , Machine room less(Geared or Gearless),Hydraulic elevators ,we have the solution for parking problems by parking lifts."/>


      <meta name="generator" content="" /> 
     
        <title>Amr Groups</title>
...
.dropdown:hover .dropbtn {
    ...
    <!--&#1575;&#1604;&#1589;&#1600;&#1600;&#1600;&#1600;&#1600;&#1608;&#1585; Start-->
       <div class="templatemo_portfolio" id="templatemo_portfolio" style="background-color:#e9e9e9">
        	<h2>Welcome To Amr Groups</h2>
            <p> 
 
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AmrGroupsConnectionString %>" SelectCommand="GetSubPicEn" SelectCommandType="StoredProcedure">
                    <SelectParameters>
